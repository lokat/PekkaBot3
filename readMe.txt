...
The core idea here is trying to compress all the code into a runable jar file. IntelliJ is not required but a program that can do this is however.

Step 4. Using IntelliJ Idea Project (https://www.jetbrains.com/idea/download/#section=windows), go to File -> Project Structure -> Artifacts. Create a jar that should look something like https://imgur.com/hch2mSu. (PekkaBot 2/3 are interchangable)
